		...
		success: function(data)
		{
			$.each(data.DATA, function(i,array)
			{
				...
				if(window.printedQuestions.indexOf(window.currentQuestion) == -1)
				{
					...
					{
						buildString +='<img class="displaycolor" src = "images/colorNA.png" width="'+window.currentLengths[5]+'px" height="'+barHeight+'px" title="N\/A: '+window.currentNA+'/'+window.currentTotal+'"> ';
					}
...
function topQuery(crn,semester,year)
{
	...
	jQuery.getJSON('https://chitester1dev.weber.edu:6838/misc/weber/CSEvals/CrnStatistics.cfm?crn='+crn+'&semester='+semester+'&year='+year+'&testId='+TestID, function(data) 
	{
		...
		tempString = tempString + '	<td><div class="container"; style="position:relative"><img align="left" src = "images/colorTopBars.png" width="'+getPixelLength(keyValPair['CLASSSCORE']).toFixed(2)+'px" height=40px"><img align="left" src = "images/colorTopBarBackground.png" width="'+(400-getPixelLength(keyValPair['CLASSSCORE']).toFixed(2))+'px" height=40px"><img style="position:absolute; top:0; left:0" src = "images/ticks.png"></div></td>';
...
//				statsTableString = statsTableString + '	<td><div class="container"><div class="overall_bar littleTicks" style="width:'+getPixelLength(crnStatistics2['INSTRUCTORCLASSFIVEYEARAVERAGE']).toFixed(2)+'px"></div></div></td>';
			...
			resultString +='								<img class="displaycolor" src = "images/colorStronglyDisagree.png" width="'+(((questionJSON[questionNumber][1])/(questionJSON[questionNumber][6]))*totalBarLength)+'px" height="'+barHeight+'px" title="Strongly Disagree: '+((questionJSON[questionNumber][1]/(questionJSON[questionNumber][6]))*100).toFixed(2)+'%"> ';
			resultString +='								<img class="displaycolor" src = "images/colorDisagree.png" width="'+(((questionJSON[questionNumber][2])/(questionJSON[questionNumber][6]))*totalBarLength)+'px" height="'+barHeight+'px" title="Disagree: '+((questionJSON[questionNumber][2]/(questionJSON[questionNumber][6]))*100).toFixed(2)+'%"> ';
			resultString +='								<img class="displaycolor"  src = "images/colorNeutral.png" width="'+(((questionJSON[questionNumber][3])/(questionJSON[questionNumber][6]))*totalBarLength)+'px" height="'+barHeight+'px" title="Neutral: '+((questionJSON[questionNumber][3]/(questionJSON[questionNumber][6]))*100).toFixed(2)+'%"> ';
			resultString +='								<img class="displaycolor" src = "images/colorAgree.png" width="'+(((questionJSON[questionNumber][4])/(questionJSON[questionNumber][6]))*totalBarLength)+'px" height="'+barHeight+'px" title="Agree: '+((questionJSON[questionNumber][4]/(questionJSON[questionNumber][6]))*100).toFixed(2)+'%"> ';
			resultString +='								<img class="displaycolor"  src = "images/colorStronglyAgree.png" width="'+(((questionJSON[questionNumber][5])/(questionJSON[questionNumber][6]))*totalBarLength)+'px" height="'+barHeight+'px" title="Strongly Agree: '+((questionJSON[questionNumber][5]/(questionJSON[questionNumber][6]))*100).toFixed(2)+'%"> ';
			if (questionJSON[questionNumber][7] > 0)
			{
				resultString +='								<img class="displaycolor"  src = "images/colorNA.png" width="'+(((questionJSON[questionNumber][7])/(questionJSON[questionNumber][6]))*totalBarLength)+'px" height="'+barHeight+'px" title="N\/A: '+((questionJSON[questionNumber][7]/(questionJSON[questionNumber][6]))*100).toFixed(2)+'%"> ';//N/A DATA
			}
			resultString +='						</div>';
			resultString +='						</td>';
			resultString +='					</tr>';
			...
			resultString +='						';
			resultString +='							<div class="graph_expanded">';
			resultString +='									<img class="displaycolor" width="'+((array['DPTSEMESTERAVERAGESD']/array['DPTSEMESTERAVERAGETOTAL'])*totalBarLength)+'px" height="'+barHeight+'px" src="images/colorStronglyDisagree.png"	title="Strongly Disagree: '+((array['DPTSEMESTERAVERAGESD']/array['DPTSEMESTERAVERAGETOTAL'])*100).toFixed(2)+'%'+'"/>';
			resultString +='									<img class="displaycolor" width="'+((array['DPTSEMESTERAVERAGED']/array['DPTSEMESTERAVERAGETOTAL'])*totalBarLength)+'px" height="'+barHeight+'px" src="images/colorDisagree.png" title="Disagree: '+((array['DPTSEMESTERAVERAGED']/array['DPTSEMESTERAVERAGETOTAL'])*100).toFixed(2)+'%'+'"/>';			
			resultString +='									<img class="displaycolor" width="'+((array['DPTSEMESTERAVERAGEN']/array['DPTSEMESTERAVERAGETOTAL'])*totalBarLength)+'px" height="'+barHeight+'px" src="images/colorNeutral.png" title="Neutral: '+((array['DPTSEMESTERAVERAGEN']/array['DPTSEMESTERAVERAGETOTAL'])*100).toFixed(2)+'%'+'"/>';
			resultString +='									<img class="displaycolor" width="'+((array['DPTSEMESTERAVERAGEA']/array['DPTSEMESTERAVERAGETOTAL'])*totalBarLength)+'px" height="'+barHeight+'px" src="images/colorAgree.png" title="Agree: '+((array['DPTSEMESTERAVERAGEA']/array['DPTSEMESTERAVERAGETOTAL'])*100).toFixed(2)+'%'+'"/>';
			resultString +='									<img class="displaycolor" width="'+((array['DPTSEMESTERAVERAGESA']/array['DPTSEMESTERAVERAGETOTAL'])*totalBarLength)+'px" height="'+barHeight+'px" src="images/colorStronglyAgree.png" title="Strongly Agree: '+((array['DPTSEMESTERAVERAGESA']/array['DPTSEMESTERAVERAGETOTAL'])*100).toFixed(2)+'%'+'"/>';
			if (array['DPTSEMESTERAVERAGENA'] > 0)
			{
				resultString +='									<img class="displaycolor" width="'+((array['DPTSEMESTERAVERAGENA']/array['DPTSEMESTERAVERAGETOTAL'])*totalBarLength)+'px" height="'+barHeight+'px" src="images/colorNA.png" title="N\/A: '+((array['DPTSEMESTERAVERAGENA']/array['DPTSEMESTERAVERAGETOTAL'])*100).toFixed(2)+'%'+'"/>';
			}
			resultString +='							</div>';
			resultString +='						</td>';
			resultString +='					</tr>';
			...
			resultString +='						';
			resultString +='							<div class="graph_expanded">';
			resultString +='								<img class="displaycolor" width="'+((array['PERSONALSEMESTERAVERAGESD']/array['PERSONALSEMESTERAVERAGETOTAL'])*totalBarLength)+'px" height="'+barHeight+'px" src="images/colorStronglyDisagree.png" title="Strongly Disagree: '+((array['PERSONALSEMESTERAVERAGESD']/array['PERSONALSEMESTERAVERAGETOTAL'])*100).toFixed(2)+'%'+'"/>	';	
			resultString +='									<img class="displaycolor" width="'+((array['PERSONALSEMESTERAVERAGED']/array['PERSONALSEMESTERAVERAGETOTAL'])*totalBarLength)+'px" height="'+barHeight+'px" src="images/colorDisagree.png" title="Disagree: '+((array['PERSONALSEMESTERAVERAGED']/array['PERSONALSEMESTERAVERAGETOTAL'])*100).toFixed(2)+'%'+'"/>';		
			resultString +='									<img class="displaycolor" width="'+((array['PERSONALSEMESTERAVERAGEN']/array['PERSONALSEMESTERAVERAGETOTAL'])*totalBarLength)+'px" height="'+barHeight+'px" src="images/colorNeutral.png" title="Neutral: '+((array['PERSONALSEMESTERAVERAGEN']/array['PERSONALSEMESTERAVERAGETOTAL'])*100).toFixed(2)+'%'+'"/>';
			resultString +='									<img class="displaycolor" width="'+((array['PERSONALSEMESTERAVERAGEA']/array['PERSONALSEMESTERAVERAGETOTAL'])*totalBarLength)+'px" height="'+barHeight+'px" src="images/colorAgree.png" title="Agree: '+((array['PERSONALSEMESTERAVERAGEA']/array['PERSONALSEMESTERAVERAGETOTAL'])*100).toFixed(2)+'%'+'"/>';
			resultString +='									<img class="displaycolor" width="'+((array['PERSONALSEMESTERAVERAGESA']/array['PERSONALSEMESTERAVERAGETOTAL'])*totalBarLength)+'px" height="'+barHeight+'px" src="images/colorStronglyAgree.png" title="Strongly Agree: '+((array['PERSONALSEMESTERAVERAGESA']/array['PERSONALSEMESTERAVERAGETOTAL'])*100).toFixed(2)+'%'+'"/>';
			if (array['PERSONALSEMESTERAVERAGENA'] > 0)
			{
				resultString +='									<img class="displaycolor" width="'+((array['PERSONALSEMESTERAVERAGENA']/array['PERSONALSEMESTERAVERAGETOTAL'])*totalBarLength)+'px" height="'+barHeight+'px" src="images/colorNA.png" title="N/\A: '+((array['PERSONALSEMESTERAVERAGENA']/array['PERSONALSEMESTERAVERAGETOTAL'])*100).toFixed(2)+'%'+'"/>';
			}
			resultString +='							</div>';
			resultString +='						</td>';
			resultString +='					</tr>	';
			...
			resultString +='								<img class="displaycolor" src = "images/colorStronglyDisagree.png" width="'+((array['DPTFIVEYEARCOURSEAVERAGESD']/array['DPTFIVEYEARCOURSEAVERAGETOTAL']))*totalBarLength+'px" height="'+barHeight+'px" title="Disagree: '+((array['DPTFIVEYEARCOURSEAVERAGESD']/array['DPTFIVEYEARCOURSEAVERAGETOTAL'])*100).toFixed(2)+'%'+'"> ';
			resultString +='								<img class="displaycolor" src = "images/colorDisagree.png" width="'+((array['DPTFIVEYEARCOURSEAVERAGED']/array['DPTFIVEYEARCOURSEAVERAGETOTAL']))*totalBarLength+'px" height="'+barHeight+'px" title="Disagree: '+((array['DPTFIVEYEARCOURSEAVERAGED']/array['DPTFIVEYEARCOURSEAVERAGETOTAL'])*100).toFixed(2)+'%'+'"> ';
			resultString +='								<img class="displaycolor"  src = "images/colorNeutral.png" width="'+((array['DPTFIVEYEARCOURSEAVERAGEN']/array['DPTFIVEYEARCOURSEAVERAGETOTAL']))*totalBarLength+'px" height="'+barHeight+'px" title="Neutral: '+((array['DPTFIVEYEARCOURSEAVERAGED']/array['DPTFIVEYEARCOURSEAVERAGETOTAL'])*100).toFixed(2)+'%'+'"> ';
			resultString +='								<img class="displaycolor" src = "images/colorAgree.png" width="'+((array['DPTFIVEYEARCOURSEAVERAGEA']/array['DPTFIVEYEARCOURSEAVERAGETOTAL']))*totalBarLength+'px" height="'+barHeight+'px" title="Agree: '+((array['DPTFIVEYEARCOURSEAVERAGEA']/array['DPTFIVEYEARCOURSEAVERAGETOTAL'])*100).toFixed(2)+'%'+'"> ';
			resultString +='								<img class="displaycolor"  src = "images/colorStronglyAgree.png" width="'+((array['DPTFIVEYEARCOURSEAVERAGESA']/array['DPTFIVEYEARCOURSEAVERAGETOTAL']))*totalBarLength+'px" height="'+barHeight+'px" title="Strongly Agree: '+((array['DPTFIVEYEARCOURSEAVERAGESA']/array['DPTFIVEYEARCOURSEAVERAGETOTAL'])*100).toFixed(2)+'%'+'"> ';
			if (array['DPTFIVEYEARCOURSEAVERAGENA'] > 0)
			{
				resultString +='								<img class="displaycolor"  src = "images/colorNA.png" width="'+((array['DPTFIVEYEARCOURSEAVERAGENA']/array['DPTFIVEYEARCOURSEAVERAGETOTAL']))*totalBarLength+'px" height="'+barHeight+'px" title="N\/A: '+((array['DPTFIVEYEARCOURSEAVERAGENA']/array['DPTFIVEYEARCOURSEAVERAGETOTAL'])*100).toFixed(2)+'%'+'"> ';
			}
			resultString +='							</div>';
			resultString +='						';
			resultString +='						</td>';
			...
			resultString +='								<img class="displaycolor" src = "images/colorStronglyDisagree.png" width="'+((array['PERSONALFIVEYEARAVERAGESD']/array['PERSONALFIVEYEARAVERAGETOTAL']))*totalBarLength+'px" height="'+barHeight+'px" title="Disagree: '+((array['PERSONALFIVEYEARAVERAGESD']/array['PERSONALFIVEYEARAVERAGETOTAL'])*100).toFixed(2)+'%'+'"> ';
			resultString +='								<img class="displaycolor" src = "images/colorDisagree.png" width="'+((array['PERSONALFIVEYEARAVERAGED']/array['PERSONALFIVEYEARAVERAGETOTAL']))*totalBarLength+'px" height="'+barHeight+'px" title="Disagree: '+((array['PERSONALFIVEYEARAVERAGED']/array['PERSONALFIVEYEARAVERAGETOTAL'])*100).toFixed(2)+'%'+'"> ';
			resultString +='								<img class="displaycolor"  src = "images/colorNeutral.png" width="'+((array['PERSONALFIVEYEARAVERAGEN']/array['PERSONALFIVEYEARAVERAGETOTAL']))*totalBarLength+'px" height="'+barHeight+'px" title="Neutral: '+((array['PERSONALFIVEYEARAVERAGEN']/array['PERSONALFIVEYEARAVERAGETOTAL'])*100).toFixed(2)+'%'+'"> ';
			resultString +='								<img class="displaycolor" src = "images/colorAgree.png" width="'+((array['PERSONALFIVEYEARAVERAGEA']/array['PERSONALFIVEYEARAVERAGETOTAL']))*totalBarLength+'px" height="'+barHeight+'px" title="Agree: '+((array['PERSONALFIVEYEARAVERAGEA']/array['PERSONALFIVEYEARAVERAGETOTAL'])*100).toFixed(2)+'%'+'"> ';
			resultString +='								<img class="displaycolor"  src = "images/colorStronglyAgree.png" width="'+((array['PERSONALFIVEYEARAVERAGESA']/array['PERSONALFIVEYEARAVERAGETOTAL']))*totalBarLength+'px" height="'+barHeight+'px" title="Strongly Agree: '+((array['PERSONALFIVEYEARAVERAGESA']/array['PERSONALFIVEYEARAVERAGETOTAL'])*100).toFixed(2)+'%'+'"> ';
			if (array['PERSONALFIVEYEARAVERAGENA'] > 0)
			{
				resultString +='								<img class="displaycolor"  src = "images/colorNA.png" width="'+((array['PERSONALFIVEYEARAVERAGENA']/array['PERSONALFIVEYEARAVERAGETOTAL']))*totalBarLength+'px" height="'+barHeight+'px" title="N\/A: '+((array['PERSONALFIVEYEARAVERAGENA']/array['PERSONALFIVEYEARAVERAGETOTAL'])*100).toFixed(2)+'%'+'"> ';
			}
			resultString +='							</div>';
			resultString +='						</td>';
			resultString +='					</tr>	';
